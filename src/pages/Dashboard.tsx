...
export function Dashboard() {
  ...
  const { patients, appointments, doctors, updateAppointmentStatus, tasks, displayPreferences } = useClinic();
  ...
  return (
    <Layout
      ...
      headerAction={hasPermission('customize_dashboard') ? (
        <button
          onClick={() => { haptic.light(); navigate('/settings/display'); }}
          className="w-10 h-10 rounded-full bg-white/80 backdrop-blur-sm border border-slate-200 flex items-center justify-center text-slate-600 shadow-sm active:scale-95 transition-all"
        >
    ...
    >
      <div className="space-y-5 pb-6">
        ...
        {displayPreferences.showDashboardStats && (
        ...
        {displayPreferences.showDashboardChart && (
        ...
        {displayPreferences.showDashboardAppointments && (
          <section>
        ...
        {/* Doctors Section */}
        {displayPreferences.showDashboardDoctors && (
          <section>
