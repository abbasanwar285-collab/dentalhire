    ...
    const getLinks = (): SidebarLink[] => {
        ...
        if (currentContext) {
            ...
            if (isEmployer) {
                ...
                return [
                    ...
                    { href: `/${context}/applications`, label: t('sidebar.applications') || (language === 'ar' ? 'طلبات التوظيف' : 'Applications'), icon: <Users size={20} /> },
            ...
            return [
                ...
                { href: `/${currentContext}/profile`, label: t('sidebar.myprofile'), icon: <User size={20} /> },
        ...
        const baseLinks: Record<string, SidebarLink[]> = {
            ...
            clinic: [
                ...
                { href: `/${employerType}/applications`, label: t('sidebar.applications') || (language === 'ar' ? 'طلبات التوظيف' : 'Applications'), icon: <Users size={20} /> },
        ...
        >
            <div className="flex flex-col h-full">
                ...
                <button
                    ...
                    className="absolute -end-3 top-24 w-6 h-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow"
